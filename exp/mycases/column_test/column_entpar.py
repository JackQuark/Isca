...
entpar = 0.50
print("Using tau_bm =", tau_bm, "entraining parameter =", entpar)
...
exp = Experiment(f'column_entpar_{entpar:.2f}', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'convection_scheme': 'ENTRAINING_QE',     #Use the simple Betts Miller convection scheme
        'do_damping': True,
        'turb':True,
        'mixed_layer_bc':True,
        'do_virtual' :False,
